      ...
      <div className="relative z-[3] hidden lg:block">
        <div className="absolute left-[48px] top-1/2 w-[440px] max-w-[34vw] -translate-y-1/2" style={{ top: "calc((100vh - 68px) / 2)" }}>
          <h1 className="font-display text-[clamp(2.4rem,3.6vw,3.4rem)] font-semibold leading-[1.15] text-[#F0EAD6]">
            <span className="block">Cari Table D&amp;D.</span>
            <span className="block">Ketemu DM Manusia.</span>
            <span className="block font-bold text-gold">Main Minggu Ini.</span>
          </h1>
          <p className="mt-[18px] mb-[34px] max-w-[360px] text-sm leading-[1.65] text-text-muted">
            Buka board, pilih campaign yang cocok dengan jadwal dan vibe mainmu, lalu apply ke DM. Bukan AI-DM. Ini tempat cari meja asli.
          </p>
          ...
          <div className="mt-[32px] flex flex-wrap gap-x-[36px] gap-y-[20px]">
            <div className="flex items-start gap-[10px]">
              ...
              <div className="text-xs leading-[1.5] text-text-muted">
                <strong className="block text-sm font-medium text-[#F0EAD6]">DM Manusia</strong>
                Profil, rating, review
              </div>
            </div>
            <div className="flex items-start gap-[10px]">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#C9A84C" strokeWidth="1.5" className="shrink-0 opacity-75">
              ...
              <div className="text-xs leading-[1.5] text-text-muted">
                <strong className="block text-sm font-medium text-[#F0EAD6]">Filter Praktis</strong>
                Jadwal, bahasa, vibe
              </div>
            </div>
            <div className="flex items-start gap-[10px]">
              ...
              <div className="text-xs leading-[1.5] text-text-muted">
                <strong className="block text-sm font-medium text-[#F0EAD6]">Apply Cepat</strong>
                Kirim request ke table
              </div>
            </div>
          </div>
        </div>
