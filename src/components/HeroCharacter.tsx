  ...
  return (
    ...
    >
      ...
      <div className="absolute left-[12%] top-[5%] z-30 flex size-[32%] items-center justify-center motion-reduce:hidden">
        ...
        <div className="hero-orbital-2 absolute right-[14%] top-[28%] size-1 rounded-full bg-ember/70 shadow-[0_0_10px_rgba(244,197,106,0.6)]" />
      </div>
      ...
      <div className="absolute left-[49%] top-[44%] z-30 size-[24%] motion-reduce:hidden">
        ...
        {/* Core gem */}
        <div className="hero-sigil-gem absolute left-1/2 top-[38%] size-[8%] -translate-x-1/2 -translate-y-1/2 rounded-sm bg-violet/60 shadow-[0_0_24px_rgba(139,92,246,0.5)]" />
      </div>
    </div>
  );
}
